...
# DATA_NAME="kubric_single_car_rand_v2_gt"
DATA_NAME="kubric_multi_car_rand_gt"
# DATA_NAME="kubric_bag_gt"
# DATA_NAME="kubric_dy_chair_gt"
# DATA_NAME="kubric_soft_gt"
...
python eval.py  \
   --root_dir $DIR  \
   --dataset_name kubric --split all_val --img_wh 256 256   \
   --N_importance 64   \
...
#! sbatch ./run_slurm_train_eval_kb.sh 